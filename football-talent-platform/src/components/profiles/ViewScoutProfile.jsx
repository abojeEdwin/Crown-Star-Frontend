...
import { ArrowLeft, Edit, MapPin, Phone, Building, Search, Eye, Star, Loader2 } from "lucide-react"
import { fetchProfileData } from "../../lib/utils"

export default function ViewScoutProfile() {
  ...
  useEffect(() => {
    const loadProfileData = async () => {
      ...
      try {
        setLoading(true)
        setError(null)
        const data = await fetchProfileData('scout', token, user.id)
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
                  <Badge className="bg-purple-600 hover:bg-purple-700">Scout</Badge>
              ...
              <Button 
                onClick={() => navigate('/profile/scout/edit')}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-gray-600">{displayData.organisation || 'Not specified'}</p>
              </div>
              
              <div>
                <h4 className="font-medium text-gray-900 mb-1">Experience</h4>
                <p className="text-gray-600">{displayData.experienceYears ? `${displayData.experienceYears} years` : 'Not specified'}</p>
              </div>
            </CardContent>
          </Card>
